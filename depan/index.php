				...
				<div class="row d-flex">
					<div class="col-md-6 col-lg-5 d-flex">
						<div class="img-about img d-flex align-items-stretch">
							<div class="overlay"></div>
							<div class="">
								<img src="images/about.jpg" class="img d-flex align-self-stretch align-items-center">
							</div>
						</div>
					</div>
					<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
						<div class="row justify-content-start pb-3">
							<div class="col-md-12 heading-section ftco-animate">
								...
								<h2 class="mb-4">Clark Thompson</h2>
								<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
								<ul class="about-info mt-4 px-md-0 px-2">
									<li class="d-flex"><span>Name:</span> <span>Clark Thompson</span></li>
									<li class="d-flex"><span>Date of birth:</span> <span>February 10, 1995</span></li>
									<li class="d-flex"><span>Address:</span> <span>London, United Kingdom</span></li>
									<li class="d-flex"><span>Zip code:</span> <span>123456</span></li>
									<li class="d-flex"><span>Email:</span> <span>test@gmail.com</span></li>
									<li class="d-flex"><span>Phone: </span> <span>+1234567890</span></li>
								</ul>
							</div>
						</div>
				...
				<div class="row d-flex">
					<div class="col-md-6 col-lg-5 d-flex">
						<div class="img-about img d-flex align-items-stretch">
							<div class="overlay"></div>
							<div class="">
								<img src="../admin/assets/img/<?= $row['foto']; ?>" class="img d-flex align-self-stretch align-items-center">
							</div>
						</div>
					</div>
					<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
						<div class="row justify-content-start pb-3">
							<div class="col-md-12 heading-section ftco-animate">
								...
								<ul class="about-info mt-4 px-md-0 px-2">
									...
									<li class="d-flex"><span>Date of birth:</span> <span><?= date('d F Y', strtotime($row['tanggal'])) ?></span></li>
						...
						<div class="row no-gutters block-9">
							<div class="col-md-6 order-md-last d-flex">
								<form action="#" class="bg-light p-4 p-md-5 contact-form" method="post">
									...
									<div class="form-group">
										<input type="submit" value="Send Message" name="simpan" class="btn btn-primary py-3 px-5">
									</div>
								</form>
